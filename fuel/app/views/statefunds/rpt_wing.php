...
<!--		<h3>Department of Water Supply & Sanitation Punjab </h3>-->
		<h4>FINANCIAL REPORT-(Wingwise)  - STATE FUNDS RELEASED (DURING 2016-17) </h4> 
	</center>
	...
	<table class="table table-striped">
		...
		?>
			...
			?>
		    	...
		    	<td style="text-align: left;"><a href="/statefunds/circle/<?php echo $fund->wing_id; ?>" >
							<?php echo $fund->wing_name ; ?></a></td>
