...
<!--		<h3>Department of Water Supply & Sanitation Punjab </h3>-->
	...
	<div class="container">
	<table>
		<td><a class="btn btn-default" href="/wbank/addnew" >Add New</a></td>
	<!--
		<td width="30">  </td>
	...
	<table class="table table-striped">
		<thead>
			...
			?>
				<td><?php echo $num; ?> </td>
				<td align="left"><?php echo $slevel->wing_name; ?></td>
				<td align="left"><?php echo $slevel->circle_name; ?></td>
		    	...
		    	<td style="text-align: center;">
		    		...
		    		<a class="btn btn-danger" href="/wbank/delete/<?php echo $slevel->slevel_id; ?>" >Delete</a>
		    	</td>
