define([
    'collections/wings',
    'text!templates/desktop/wing/collection.html',
    'text!templates/desktop/wing/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "circles") {
                window.location.href = "#circles/wing/" + this.model.id;
            }
    ...
    var TemplatesCollectionView = Backbone.View.extend({
        ...
        initialize:function () {
            _.bindAll(this, 'addOne', 'addAll', 'render', 'import_data', 'export_data');
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data:function () {
            ...
            wing_id = "all";
            window.location.href = "/export/wings/" + wing_id;
        },
        refresh:function () {
