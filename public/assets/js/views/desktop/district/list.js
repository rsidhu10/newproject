define([
    ...
    'text!templates/desktop/district/collection.html',
    'text!templates/desktop/district/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "divisions") {
                window.location.href = "#divisions/district/" + this.model.id;
            }
            return false;
        }
    });
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/districts/circle/" + id;
        },
        refresh:function () {
