define([
    'collections/circles',
    'text!templates/desktop/circle/collection.html',
    'text!templates/desktop/circle/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        events: {
            "click .districts": 'DistrictClicked'
        },
        initialize:function () {
            _.bindAll(this, 'render', "remove", "DistrictClicked");
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/circles/wing/" + id;
        },
        refresh:function () {
