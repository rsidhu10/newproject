// from home/main.js
define([
    'text!templates/desktop/subdivision/main.html',
    ...
    var aView = Backbone.View.extend({
        render:function () {
            ...
            require(['collections/subdivisions', 'views/desktop/subdivision/list'], function (Collection, CollectionView) {
                var aCollection = new Collection;
                aCollection.url = '/subdivisions/division/' + parent_model_id;
