define([
    'collections/blocks',
    'text!templates/desktop/block/collection.html',
    'text!templates/desktop/block/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "panchayats") {
                window.location.href = "#panchayats/block/" + this.model.id;
            }
            return false;
        }
    });
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/blocks/subdivision/" + id;
        },
        refresh:function () {
