define([
    'text!templates/desktop/billing/panchayat_dd_model.html',
    'text!templates/desktop/billing/panchayat_dd_collection.html',
    'collections/panchayats',
    'text!templates/desktop/billing/panchayat_dd_selected.html',
    'backbone'
    ...
    var PanchayatModelView = Backbone.View.extend({
        tagName:'li',
        ...
        initialize:function () {
//            console.log("PanchayatModelView: initialize");
            //_.bindAll(this, 'render');
            //this.model.bind('change', this.render);
        },
        render:function () {
//            console.log("PanchayatModelView: render");
            $(this.el).html(this.template(this.model.toJSON()));
            return this;
        },
        TemplateClicked:function (e) {
//            console.log("PanchayatModelView: TemplateClicked");
            e.stopPropagation();
//            console.log('Model clicked :' + this.model.id + ': ' + this.model.get('name'));
    ...
    var PanchayatCollectionView = Backbone.View.extend({
...
//            console.log("PanchayatCollectionView: initialize");
            ...
            $('#create_bill_wizard_panchayat_row').html(this.template());
            $('#create_bill_wizard_panchayat_row').removeClass("hidden");
            $("#create_bill_wizard_panchayat_row :button").button('loading');
            //$("#create_bill_wizard_panchayat_row :button").button('reset');

            this.collection.url = "/panchayats/block/" + this.options.block_id;
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        refresh:function () {
//            console.log("PanchayatCollectionView: refresh");
            //console.log('refresh(): Templates Collection View: refresh() - doesnt do anything');
        },
        render:function () {
//            console.log("PanchayatCollectionView: render");
...
//            $(this.el).append(this.template());
        ...
        addAll:function () {
//            console.log("PanchayatCollectionView: addAll");
...
//            console.log("PanchayatCollectionView: addOne");
            var view = new PanchayatModelView({model:aModel});

            //console.log(view.render().el);
            $(this.options.el).find('#create_bill_wizard_panchayat_dd').last().append(view.render().el);
        },
        checkSelections:function () {
//            console.log("PanchayatCollectionView: checkSelections");
//            console.log("checkSelections, items in collection: " + this.collection.length);
            athis = this;

            //console.log(aModel);
            //this.collection.each(this.addOne);
            this.collection.each(function (aPanchayat) {
                if (aPanchayat.has("selected")) {
                    $("#create_bill_wizard_block_row :button").remove();
                    $('#create_bill_wizard_panchayat_row').empty();
                    newTemplate = _.template(aModelSelectedTemplate);
                    $('#create_bill_wizard_panchayat_row').html(newTemplate(aPanchayat.toJSON()));
                    $('#create_bill_wizard_panchayat_row').addClass('success');
                    $("#create_bill_wizard_panchayat_row :button").bind('click', athis.CreateJobClicked);
                    require(['views/desktop/billing/village_dd'], function (aView) {
                        var myView = new aView({el:'#create_bill_wizard_village_row', panchayat_id:aPanchayat.id});
                    });
                }
            });
        },
    ...
    return PanchayatCollectionView;
});
