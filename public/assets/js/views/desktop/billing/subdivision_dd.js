define([
    'text!templates/desktop/billing/subdivision_dd_model.html',
    'text!templates/desktop/billing/subdivision_dd_collection.html',
    'collections/subdivisions',
    'text!templates/desktop/billing/subdivision_dd_selected.html',
    'backbone'
    ...
    var SubdivisionModelView = Backbone.View.extend({
        ...
        initialize:function () {
            //console.log("SubdivisionModelView: initialize");
            //_.bindAll(this, 'render');
            //this.model.bind('change', this.render);
        },
        render:function () {
            //console.log("SubdivisionModelView: render");
