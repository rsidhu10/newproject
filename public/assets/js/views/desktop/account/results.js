define([
    ...
    'text!templates/desktop/account/resultscollection.html',
    'text!templates/desktop/account/resultsmodel.html',
    'backbone'
...
//            window.location.href = "#ledger/edit/" + this.model.get('account_number');
            window.app_router.navigate("ledger/edit/" + this.model.get('account_number'), {trigger: true});
            return false;
        }
    });
...
//                id = url[3];
//            }
//            window.location.href = "/export/consumers/habitation/" + id;
//        },
        refresh:function () {
