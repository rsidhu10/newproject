define([
    ...
    'text!templates/desktop/panchayat/collection.html',
    'text!templates/desktop/panchayat/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "villages") {
                window.location.href = "#villages/panchayat/" + this.model.id;
            }
            return false;
        }
    });
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/panchayats/block/" + id;
        },
        refresh:function () {
