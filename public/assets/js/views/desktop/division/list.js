define([
    ...
    'text!templates/desktop/division/collection.html',
    'text!templates/desktop/division/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "subdivisions") {
                window.location.href = "#subdivisions/division/" + this.model.id;
            }
            return false;
        }
    });
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/divisions/district/" + id;
        },
        refresh:function () {
