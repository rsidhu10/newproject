define([
    ...
    'text!templates/desktop/village/collection.html',
    'text!templates/desktop/village/model.html',
    'backbone'
    ...
    var TemplateModelView = Backbone.View.extend({
        ...
        TemplateClicked:function (e) {
            ...
            if (e.target.name == "habitations") {
                window.location.href = "#habitations/village/" + this.model.id;
            }
            return false;
        }
    });
...
//                    console.log("success! # of Templates: " + model.length);
        ...
        export_data: function() {
            ...
            window.location.href = "/export/villages/panchayat/" + id;
        },
        refresh:function () {
